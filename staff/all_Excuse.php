...
function getState($state){
    ...
    switch ($state){
        ...
        case 1:
            $state = "<span class='text-warning'>Pending</span>";
            break;

        case 2:
            $state = "<span class='text-success'>Accepted</span>";
            break;

        case 3:
            $state = "<span class='text-danger'>Refused</span>";
            break;
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="all_Excuse.php"><em class="fa fa-calendar">&nbsp;</em> Browse All Excuses</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                $stmt = $conn->prepare("SELECT * FROM excuses JOIN student ON excuses.student_id = student.student_id JOIN course ON excuses.course_id = course.course_id JOIN teatcher ON excuses.teatcher_id = teatcher.teatcher_id ORDER BY `excuses`.`excuse_id` ASC");
                $stmt->execute();
                $rows = $stmt->fetchAll();
